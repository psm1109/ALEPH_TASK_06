...
create policy "public reflections insert" on public.reflections for insert to anon
  with check (workspace_id = 'ccna-main');
create policy "public reflections update" on public.reflections for update to anon
  using (workspace_id = 'ccna-main')
  with check (workspace_id = 'ccna-main');
create policy "public reflections delete" on public.reflections for delete to anon
  using (workspace_id = 'ccna-main');
...
-- 계획 버전은 추가 전용이며, 할 일·실행 기록·회고 기록은 수정/삭제를 허용합니다.
