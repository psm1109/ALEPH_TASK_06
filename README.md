...
- 할 일 수는 현재 계획에 연결된 할 일을 집계합니다. 완료 수는 집계 기간에 실행 기록이 있는 할 일의 날짜별 합계이며, 같은 할 일의 실행 기록이 하루에 여러 건이어도 1건만 셉니다. 막힘 수는 현재 자료에서 집계합니다. 지연 수는 서울 날짜별 미완료 기록의 합계입니다. 같은 할 일이 여러 날 미완료였다면 날짜마다 1건씩 기록합니다.
